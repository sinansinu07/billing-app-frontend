...
export const startGetProducts = () => { 
    return async (dispatch) => {
        try {
            const response = await axios.get('http://localhost:3070/api/products')
...
export const startCreateProduct = (formData, resetForm) => {
    return async (dispatch) => {
        try {
            const response = await axios.post('http://localhost:3070/api/products', formData)
...
export const startUpdateProduct = (id, formData, resetForm, toggle) => {
    return async (dispatch) => {
        try {
            const response = await axios.put(`http://localhost:3070/api/products/${id}`, formData) 
...
export const startDeleteProduct = (id) => {
    return async (dispatch) => {
        try {
            const response = await axios.delete(`http://localhost:3070/api/products/${id}`)
